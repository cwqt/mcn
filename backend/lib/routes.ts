...
import Dashboards  = require("./controllers/Dashboards.controller");
...
mcnr.put     <IDashboard>       ("/dashboards/:did",                     Dashboards.updateDashboard,               [Access.OrgMember]);
mcnr.delete  <void>             ("/dashboards/:did",                     Dashboards.deleteDashboard,               [Access.OrgMember]);
mcnr.post    <IDashboardSection>("/dashboards/:did/sections",            Dashboards.addSection,                    [Access.OrgMember]);
// SECTIONS ------------------------------------------------------------------------------------------------------------------------------------------------------
...
// TASK ROUTINES -------------------------------------------------------------------------------
//mcnr.get                      ("/routines/:trid",                      Task.readTaskRoutine)
//mcnr.put                      ("/routines/:trid",                      Task.updateTaskRoutine)

// TASKS -------------------------------------------------------------------------------
//mcnr.post                     ("/tasks",                               Task.createTask)
//mcnr.put                      ("/tasks/:tid",                          Task.updateTask)
//mcnr.delete                   ("/tasks/:tid",                          Task.deleteTask)
