...
@Component({
  selector: "app-select-sources-dialog",
  templateUrl: "./select-sources-dialog.component.html",
  styleUrls: ["./select-sources-dialog.component.scss"],
})
export class SelectSourcesDialogComponent implements OnInit {
  constructor(
    ...
    private dialogRef: MatDialogRef<SelectSourcesDialogComponent>
  ) {}
